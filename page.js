...
var page = {
  ...
  */
  createSelectionArea: function() {
    var areaProtector = _$('sc_drag_area_protector');
    ...
    _$('sc_drag_container').addEventListener('dblclick', function() {
      page.removeSelectionArea();
      page.sendMessage({msg: 'capture_selected'});
    }, false);

    page.pageHeight = _$('sc_drag_area_protector').clientHeight;
    page.pageWidth = _$('sc_drag_area_protector').clientWidth;

    var areaElement = _$('sc_drag_area');
  ...
  */
  updateShadow: function(areaElement) {
    _$('sc_drag_shadow_top').style.height =
        parseInt(areaElement.style.top) + 'px';
    _$('sc_drag_shadow_top').style.width = (parseInt(areaElement.style.left) +
        parseInt(areaElement.style.width) + 1) + 'px';
    _$('sc_drag_shadow_left').style.height =
        (page.pageHeight - parseInt(areaElement.style.top)) + 'px';
    _$('sc_drag_shadow_left').style.width =
    ...
    _$('sc_drag_shadow_right').style.height = height + 'px';
    _$('sc_drag_shadow_right').style.width =  width + 'px';
    ...
    width = (width < 0) ? 0 : width;
    _$('sc_drag_shadow_bottom').style.height = height + 'px';
    _$('sc_drag_shadow_bottom').style.width = width + 'px';
  },
  ...
  */
  removeSelectionArea: function() {
    ...
    _$('sc_drag_container').removeEventListener('dblclick',function() {
      page.removeSelectionArea();
  ...
  */
  updateSize: function() {
    ...
    _$('sc_drag_size').innerText = page.calculateSizeAfterZooming(width) +
  ...
  */
  init: function() { 
    ...
    this.injectCssResource('css/style.css');
